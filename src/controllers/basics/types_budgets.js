...
module.exports = {
	...
	async get(req, res, self) {
		await CrudBasicsController.get(req, res, TypeBudget)
	},
	...
	async list(req, res, self) {
		await CrudBasicsController.list(req, res, TypeBudget)
	},
	...
	async create(req, res, self) {
		await CrudBasicsController.create(req, res, TypeBudget)
	},
	...
	async change(req, res, self) {
		await CrudBasicsController.change(req, res, TypeBudget)
	},
	...
	async delete(req, res, self) {
		await CrudBasicsController.delete(req, res, TypeBudget)
	},
	...
	async restore(req, res, self) {
		await CrudBasicsController.restore(req, res, TypeBudget)
	},
}
